        ...
        <div className="text-center mx-auto w-1/2">
          ...
          <div className="tab">
            ...
            <ul className="flex mt-8 justify-center gap-4 flex-wrap">
              ...
              <li
                className={`flex-1 ${isactive === "burger" ? "btn3" : "btn2"}`}
                onClick={() => {
                  setfood_type("burger");
                  setisactive("burger");
                }}
              ...
              <li
                className={`flex-1 ${
                  isactive === "beverage" ? "btn3" : "btn2"
                }`}
                onClick={() => {
                  setfood_type("beverage");
                  setisactive("beverage");
                }}
              >
                Snack
              </li>
              <li
                className={`flex-1 ${isactive === "snack" ? "btn3" : "btn2"}`}
                onClick={() => {
                  setfood_type("snack");
                  setisactive("snack");
                }}
              ...
              return (
                <div key={index}>
                  <div className="hover:bg-secondaryColor hover:opacity-70 p-16 rounded-3xl mb-4 md:h-60 grid place-items-center lg:p-4 lg:h-40 bg-primaryColorLight">
                    <img src={card.img} alt="Error" className="w-20 mx-auto" />
                  </div>
                  <div>
                    <h4 className="3xl uppercase font-bold font-Roboto">
                      {card.title}
                    </h4>
                    <p className=" text-sm ">{card.about}</p>
                    <div className="mt-2 font-Roboto text-fuchsia-300">
                      {card.price}
                    </div>
                  </div>
                </div>
